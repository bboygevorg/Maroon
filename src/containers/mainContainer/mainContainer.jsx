            ...
            <section className={`${classes.mainBlock} ${classes.individual}`}>
                <div className={classes.individualContainer}>
                    <SectionDetails  classes={classes.individualContent}
                                     ...
                                     description={
                                         <span>
                                             <span>Не всегда очевидно, какие элементы и минералы необходимы коже, а многочисленные эксперименты с разными средствами только ухудшают ее качество.</span>
                                             <br/>
                                             <br/>
                                             <span>Заполните анкету, и мы подберем уход, подходящий именно вам, учитывая ваш образ жизни, место жительства и другие факторы.</span>
                                         </span>
                                     }
